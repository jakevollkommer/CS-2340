...
public class Student implements Parcelable {
    ...
    public static List<String> classStandings = Arrays.asList("Freshman", "Sophomore", "Junior", "Senior");
    ...
    public ClassStanding getClassStanding() { return _standing; };
    public void setClassStanding(ClassStanding standing) { _standing = standing; }
    ...
    /**
     * Make a new student, defaulted to a freshman
