...
public class EditStudentActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    /* ***********************
       Data for class standing changes
     */
    private Student _standing;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        classStandingSpinner = (Spinner) findViewById(R.id.class_standing_spinner);
        ...
        /*
          Set up the adapter to display the possible class standings in the spinner
         */
        ...
        classStandingSpinner.setAdapter(standingAdapter);
